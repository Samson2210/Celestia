...
export function EduTopSection() {
    return (
    <>
        <div className="absolute w-full md:w-10/12 max-w-3xl xl:max-w-4xl h-80vh left-0 md:left-4 bg-opacity-25 xl:mt-20 flex flex-col items-start justify-center pt-2  xl:pt-18 pl-8 z-10">
        ...
        <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 z-20">
            <a href="#scroll-target" className="px-6 py-3 bg-green-600 text-white text-base md:text-lg font-semibold rounded-lg transition duration-300 ease-in-out hover:bg-transparent hover:border-2 hover:border-green-600 focus:outline-none focus:border-green-600" onClick={handleButtonClick}>Begin Your Exploration</a>
        </div>
    </>
    );
}
